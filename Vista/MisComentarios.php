...
<body>
    <table class="table">
        <thead>
            ...
            <div class="table__title">Mis Reseñas</div>
        <tbody>
    ...
    <div class="table__title">Mis Comentarios</div>
    ...
    <table class="table">
        ...
        <?php $resultado2 = mysqli_query($conexion, $comentariosProductosUsuario);
        while($row2=mysqli_fetch_assoc($resultado2)){ ?>
            <?php $idProductoComentario = (int)$row2["idMercaderia"];?>
            <tr>
                <th><?php echo mysqli_fetch_assoc(mysqli_query($conexion, "SELECT * FROM mercaderia WHERE id = $idProductoComentario"))["nombre"];?></th>
